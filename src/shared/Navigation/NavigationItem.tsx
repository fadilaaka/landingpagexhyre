  ...
  const renderMainItem = (item: NavItemType) => {
    return (
      <NavLink
        ...
        className="inline-flex items-center text-sm xl:text-base font-normal text-black dark:text-white py-2 px-4 xl:px-5 rounded-full hover:text-neutral-900 hover:bg-neutral-100 dark:hover:bg-neutral-800 dark:hover:text-neutral-200"
        to={{
          pathname: item.href || undefined,
        }}
